...
import ColumnHeader from './UserColumn';
...
const UserTable = () => {
    ...
    useEffect(() => {
      ...
      const UserData = data && data.users.filter((user)=>user.isAdmin === false && user.isOwner === false);

      return (
        <div className="min-h-[90vh] w-full space-y-6">
        <div className="h-8  w-full ">
          <h1 className="hidden text-4xl  lg:block "> New Users</h1>
        </div>
        <div
