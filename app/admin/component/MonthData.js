...
import {
  MonthAreaChartSeries,
  MonthAreaChartOptions,
  MonthBarChartSeries,
  MonthBarChartOptions,
  MonthStackColumnSeries, MonthStackColumnOptions, MonthStackRowSeries, MonthStackRowOptions
    ...
    <div className="h-[90vh] w-full">
      ...
      >
        <div className="rounded-3xl bg-white p-4 shadow-md md:col-span-3 ">
          <StackedColumn options={MonthStackColumnOptions} series={MonthStackColumnSeries}/>
        </div>
        <div className="rounded-3xl bg-white p-4 shadow-md md:col-span-2 ">
          <StackedRow series={MonthStackRowSeries} options={MonthStackRowOptions}/>
        </div>
        <div className=" grid-row-2 grid grid-cols-2 gap-6 md:col-span-2">
          <div className="col-span-2 rounded-3xl bg-white p-4 shadow-md">
            <AreaChart
              options={MonthAreaChartOptions}
              series={MonthAreaChartSeries}
            />
          </div>
