...
import additionalCharges from "@/app/models/setting/additionalCharges";
...
export async function POST(req, res) {
    ...
    try {
        ...
        await newAdditionalCharges.save();
        return Response.json({ message: "Additional Charges created successfully" }, { status: 200 });
